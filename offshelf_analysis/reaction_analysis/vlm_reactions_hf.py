...
class HuggingFaceVideoAnalyzer:
    def __init__(self, 
                 ...
                 prompt="Given the human reaction shown in the image, do you think this situation ends well or poorly? Answer with only one word.",
                 video_folder="./videos",
...
def main():
    ...
    parser.add_argument('--prompt', type=str, 
                        default='Given the human reaction shown in the image, do you think this situation ends well or poorly? Answer with only one word.',
...
# python hf_video_analyzer.py --model "llava-hf/llava-v1.6-mistral-7b-hf"
# python hf_video_analyzer.py --model "llava-hf/llava-1.5-7b-hf"
# python hf_video_analyzer.py --model "Salesforce/blip2-opt-2.7b"
